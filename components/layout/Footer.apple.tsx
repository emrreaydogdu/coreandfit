...
export const Footer: React.FC = () => {
  ...
  // Portal and Admin pages have dedicated layouts
  if (pathname?.startsWith("/portal") || pathname?.startsWith("/admin")) {
    return null;
  }

  return (
    <footer className="bg-[#F5F5F7] dark:bg-[#0A0A0C] border-t border-black/[0.06] dark:border-white/[0.08] pt-16 pb-28 md:pb-16 text-slate-600 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-14 border-b border-black/[0.06] dark:border-white/[0.08]">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 max-w-sm leading-relaxed">
              Standart kalabalık salon anlayışından uzak; hedefinize, biyomekaniğinize ve yaşam tarzınıza özel 1:1 kişisel antrenman ve performans koçluğu. Kurucu & Baş Antrenör İlker Yüksel.
            </p>

            <div className="flex items-center gap-2 mt-2">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-[#121214] border border-black/[0.06] dark:border-white/[0.08] text-xs shadow-sm">
                <div className="flex items-center gap-0.5 text-amber-500">
                  <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                </div>
                <span className="text-slate-900 dark:text-white font-bold">4.2 / 5</span>
                <span className="text-slate-600 dark:text-slate-400 text-[11px]">(62 Google Yorumu)</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            <ul className="space-y-2.5 text-xs font-medium">
              ...
              <li>
                <Link
                  href="/portal"
                  className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors flex items-center gap-1.5 text-emerald-700 dark:text-emerald-400 font-bold"
                >
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-[11px] mt-0.5">Yalnızca randevulu danışanlar kabul edilir.</p>
                </div>
              </div>

              <a
                href={BUSINESS_CONFIG.phoneTel}
                className="flex items-center gap-2.5 text-slate-700 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-white transition-colors"
              >
