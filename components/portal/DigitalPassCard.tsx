        ...
        <div className="relative z-10 flex flex-col justify-between h-full min-h-[195px]">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-2xl bg-[#0F172A] flex items-center justify-center font-mono font-black text-white text-xs shadow-sm">
                CF
              </div>
              <div>
            ...
            <div className="flex items-center gap-1.5 px-3 py-1 bg-white border border-black/[0.06] rounded-full shadow-xs">
              ...
              <span className="text-[10px] font-mono font-bold tracking-wider text-[#0F172A] uppercase">
                AKTİF ÜYE
              </span>
            </div>
          </div>
          ...
          <div className="my-3 flex items-end justify-between">
            <div>
              <span className="text-[10px] font-mono text-[#94A3B8] uppercase tracking-wider block mb-0.5">
                ÜYE STATÜSÜ
              </span>
            ...
            <div className="flex flex-col items-center gap-1 bg-white border border-black/[0.08] p-2.5 rounded-2xl shadow-xs group-hover:border-[#0F172A] transition-colors">
              ...
              <span className="text-[8px] font-mono text-[#64748B] uppercase tracking-wider flex items-center gap-0.5 font-bold">
                <span>DOKUN</span>
          ...
          {/* Bottom Pass Meta */}
          <div className="pt-3.5 border-t border-black/[0.06] flex items-center justify-between text-xs font-mono">
            <div>
        ...
        {showQrModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
            ...
            >
              ...
              <div className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-[#F1F5F9] text-[#0F172A] rounded-full text-xs font-mono font-bold uppercase tracking-wider mb-4 border border-black/[0.04]">
              ...
              <p className="text-xs font-mono text-[#64748B] mt-1 mb-6">
              ...
              <div className="relative mx-auto w-56 h-56 bg-white p-4 rounded-3xl border-2 border-[#0F172A] shadow-lg flex flex-col items-center justify-center">
                <div className="w-full h-full p-2 flex flex-col items-center justify-center bg-white">
                  ...
                  <span className="font-mono text-[10px] font-black tracking-widest text-[#0F172A] mt-1">
                    {user.memberNo}
                  </span>
                </div>
                <div className="absolute -bottom-3 bg-[#0F172A] text-white px-4 py-1 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider shadow">
                  GİRİŞTE OKUTUNUZ
                </div>
              </div>

              <div className="mt-8 pt-5 border-t border-black/[0.06] text-xs font-mono text-[#64748B] space-y-1">
